            ...
            <div className="space-y-6">
              <LiquidGlassCard className="p-8 flex flex-col items-center justify-center border-purple-500/20" accentColor="#8b5cf6">
                ...
                <button
                  ...
                  disabled={isPlaying}
                  className={`h-24 w-24 rounded-full flex items-center justify-center transition-all duration-500 ${isPlaying
            ...
            <div className="space-y-6">
              <LiquidGlassCard className="p-6 text-center" accentColor="#8b5cf6">
                ...
                <button
                  ...
                  disabled={isPlaying}
                  className={`h-20 w-20 rounded-full flex items-center justify-center mx-auto transition-all ${isPlaying ? "bg-purple-600 animate-pulse" : "bg-purple-500/20 hover:bg-purple-500/30"
                    }`}
                >
            ...
            <div className="space-y-6 max-w-lg mx-auto">
              <LiquidGlassCard className="p-6 md:p-8" accentColor="#8b5cf6">
                ...
                <button
                  ...
                  disabled={isPlaying}
                  className={`h-20 w-20 rounded-full flex items-center justify-center mx-auto mb-6 transition-all ${isPlaying ? "bg-purple-600 animate-pulse" : "bg-purple-500/20 hover:bg-purple-500/30"
                    }`}
                >
                  <Play className="w-8 h-8 text-purple-400" />
                </button>
